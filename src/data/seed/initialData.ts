...
export const INITIAL_HISTORICAL_SIGNALS: SignalSnapshot[] = [
  ...
  // 국내 대표 종목 백테스트 & 시그널 데이터 (KR)
  {
    id: 'sig-2026-08-16-000660',
    ...
    components: {
      weights: { technical: 0.25, momentum: 0.3, fundamental: 0.3, valuation: 0.15 },
      risk_reasons: ['HBM 사이클 모멘텀 지속 및 외인 순매수 유입'],
      decision_reason: '엔비디아 HBM 핵심 공급사로서 AI 사이클 주도주 모멘텀 지속',
    },
  },
  {
    id: 'sig-2026-08-10-005930',
    ...
    components: {
      weights: { technical: 0.25, momentum: 0.3, fundamental: 0.3, valuation: 0.15 },
      risk_reasons: ['국내 1위 시가총액 우량주, 하방 경직성 확보'],
      decision_reason: '메모리 반도체 턴어라운드 및 저평가 밸류에이션 매력 부각',
    },
  },
  {
    id: 'sig-2026-07-28-069500',
    ...
    components: {
      weights: { technical: 0.45, momentum: 0.45, fundamental: 0.0, valuation: 0.1 },
      risk_reasons: ['시장 대표 지수 추종으로 개별 기업 리스크 분산'],
      decision_reason: '코스피 200 지수 20일선 지지 후 완만한 정배열 반등 추세',
    },
  },
  {
    id: 'sig-2026-07-12-005380',
    ...
    components: {
      weights: { technical: 0.25, momentum: 0.3, fundamental: 0.3, valuation: 0.15 },
      risk_reasons: ['주주환원 확대 및 하이브리드 판매 호조'],
      decision_reason: '기업 밸류업 프로그램 및 우수한 글로벌 완성차 영업이익률',
    },
  },
  {
    id: 'sig-2026-06-25-360750',
    ...
    components: {
      weights: { technical: 0.45, momentum: 0.45, fundamental: 0.0, valuation: 0.1 },
      risk_reasons: ['절세 연금 계좌 최우선 편입 대상, 장기 우상향'],
      decision_reason: 'S&P 500 우상향 추세 속 단기 눌림목 반등 확인',
    },
  },
  {
    id: 'sig-2026-06-08-196170',
    ...
    components: {
      weights: { technical: 0.45, momentum: 0.45, fundamental: 0.0, valuation: 0.1 },
      risk_reasons: ['코스닥 바이오 고변동성 주의 (HIGH)'],
      decision_reason: '글로벌 빅파마 로열티 유입 기대감 및 강력한 저항선 돌파',
    },
  },
];
...
export function runPipelineOnSeedData(
  ...
  for (const item of allSeedItems) {
    ...
    const region = detectMarketRegion(item.ticker);
