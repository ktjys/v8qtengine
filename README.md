...
| **시그널 라이프사이클** | 발생 당시 지표를 영구 보존하는 **불변 스냅샷 원장 + 5D/10D/20D/60D/120D/252D 사후 성과 추적** |
...
- **성과 지표 완전 산출**: 5일 / 10일 / 20일 / 60일 / 120일 / 252일 승률(Win Rate), 평균 수익률, 중위 수익률, MDD(최대 낙폭), Profit Factor(총이익/총손실), 수학적 기대값(Expectancy) 산출.
...
- [x] **P2: Long-Horizon Backtest Metrics** - 60일/120일/252일 사후 성과 지표 및 백테스트 UI 확장
